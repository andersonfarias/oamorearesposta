...
ActiveRecord::Schema.define(version: 2017_11_25_055138) do
  ...
  create_table "activity_diaries", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["activity_id"], name: "index_activity_diaries_on_activity_id"
    t.index ["diary_id"], name: "index_activity_diaries_on_diary_id"
  end
  ...
  create_table "albergues", id: :serial, force: :cascade do |t|
  ...
  create_table "alcohols", id: :serial, force: :cascade do |t|
  ...
  create_table "assistance_activities", id: :serial, force: :cascade do |t|
  ...
  create_table "attendances", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["activity_diary_id"], name: "index_attendances_on_activity_diary_id"
    t.index ["beneficiary_id"], name: "index_attendances_on_beneficiary_id"
  end

  create_table "axis1s", id: :serial, force: :cascade do |t|
    t.string "i_3_1_1"
    t.string "i_3_1_2"
    t.string "i_3_1_3"
    t.string "i_3_1_4"
  ...
  create_table "axis2s", id: :serial, force: :cascade do |t|
    t.string "i_3_2_1"
    t.string "i_3_2_2"
    t.string "i_3_2_3"
    t.string "i_3_2_4"
  ...
  create_table "axis3s", id: :serial, force: :cascade do |t|
    t.string "i_3_3_1"
    t.string "i_3_3_2"
    t.string "i_3_3_3"
    t.string "i_3_3_4"
  ...
  create_table "axis4s", id: :serial, force: :cascade do |t|
    t.string "i_3_4_1"
    t.string "i_3_4_2"
    t.string "i_3_4_3"
    t.string "i_3_4_4"
  ...
  create_table "axis5s", id: :serial, force: :cascade do |t|
    t.string "i_3_5_1"
    t.string "i_3_5_2"
    t.string "i_3_5_3"
    t.string "i_3_5_4"
  ...
  create_table "basic_assistances", id: :serial, force: :cascade do |t|
    t.string "i_10_1"
    t.string "i_10_2"
    t.string "i_10_3"
    t.string "i_10_4"
  ...
  create_table "beneficiaries", id: :serial, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.boolean "is_active", default: true
    t.index ["department_id"], name: "index_beneficiaries_on_department_id"
    t.index ["person_id"], name: "index_beneficiaries_on_person_id"
  end
  ...
  create_table "citizens", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["comunity_id"], name: "index_citizens_on_comunity_id"
    t.index ["person_id"], name: "index_citizens_on_person_id"
  end

  create_table "community_treatments", id: :serial, force: :cascade do |t|
  ...
  create_table "comunities", id: :serial, force: :cascade do |t|
    t.string "name"
    t.text "description"
  ...
  create_table "dependent_educations", id: :serial, force: :cascade do |t|
  ...
  create_table "dependent_healths", id: :serial, force: :cascade do |t|
  ...
  create_table "dependent_variables", id: :serial, force: :cascade do |t|
    ...
    t.index ["alcohol_id"], name: "index_dependent_variables_on_alcohol_id"
    t.index ["basic_assistance_id"], name: "index_dependent_variables_on_basic_assistance_id"
    t.index ["dependent_education_id"], name: "index_dependent_variables_on_dependent_education_id"
    t.index ["dependent_health_id"], name: "index_dependent_variables_on_dependent_health_id"
    t.index ["drug_id"], name: "index_dependent_variables_on_drug_id"
    t.index ["family_id"], name: "index_dependent_variables_on_family_id"
    t.index ["feeding_id"], name: "index_dependent_variables_on_feeding_id"
    t.index ["group_life_id"], name: "index_dependent_variables_on_group_life_id"
    t.index ["home_id"], name: "index_dependent_variables_on_home_id"
    t.index ["hygiene_id"], name: "index_dependent_variables_on_hygiene_id"
    t.index ["job_id"], name: "index_dependent_variables_on_job_id"
    t.index ["legality_id"], name: "index_dependent_variables_on_legality_id"
    t.index ["main_network_id"], name: "index_dependent_variables_on_main_network_id"
    t.index ["psychological_situation_id"], name: "index_dependent_variables_on_psychological_situation_id"
    t.index ["self_security_id"], name: "index_dependent_variables_on_self_security_id"
    t.index ["sexual_life_id"], name: "index_dependent_variables_on_sexual_life_id"
  end

  create_table "diagnosis_and_case_evaluations", id: :serial, force: :cascade do |t|
  ...
  create_table "diaries", id: :serial, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "axis"
    t.index ["beneficiary_id"], name: "index_diaries_on_beneficiary_id"
  ...
  create_table "evaluations", id: :serial, force: :cascade do |t|
    ...
    t.boolean "is_active", default: true
    t.index ["beneficiary_id"], name: "index_evaluations_on_beneficiary_id"
    t.index ["dependent_variable_id"], name: "index_evaluations_on_dependent_variable_id"
    t.index ["independent_variable_id"], name: "index_evaluations_on_independent_variable_id"
    t.index ["problems_during_process_id"], name: "index_evaluations_on_problems_during_process_id"
  ...
  create_table "field_diaries", id: :serial, force: :cascade do |t|
    t.date "data"
    t.text "descricao"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "file_pictures", id: :serial, force: :cascade do |t|
    t.string "file_name"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["activity_diary_id"], name: "index_file_pictures_on_activity_diary_id"
  end

  create_table "first_contact_files", id: :serial, force: :cascade do |t|
    t.date "date"
    t.integer "hour"
    ...
    t.index ["beneficiary_id"], name: "index_first_contact_files_on_beneficiary_id"
    t.index ["user_id"], name: "index_first_contact_files_on_user_id"
  end

  create_table "group_lives", id: :serial, force: :cascade do |t|
  ...
  create_table "guidelines_references", id: :serial, force: :cascade do |t|
  ...
  create_table "hygienes", id: :serial, force: :cascade do |t|
  ...
  create_table "independent_variables", id: :serial, force: :cascade do |t|
    ...
    t.integer "axis4_id"
    t.integer "axis5_id"
    t.index ["albergue_id"], name: "index_independent_variables_on_albergue_id"
    t.index ["assistance_activity_id"], name: "index_independent_variables_on_assistance_activity_id"
    t.index ["axis1_id"], name: "index_independent_variables_on_axis1_id"
    t.index ["axis2_id"], name: "index_independent_variables_on_axis2_id"
    t.index ["axis3_id"], name: "index_independent_variables_on_axis3_id"
    t.index ["axis4_id"], name: "index_independent_variables_on_axis4_id"
    t.index ["axis5_id"], name: "index_independent_variables_on_axis5_id"
    t.index ["community_treatment_id"], name: "index_independent_variables_on_community_treatment_id"
    t.index ["diagnosis_and_case_evaluation_id"], name: "index_independent_variables_on_diagnosis_and_case_evaluation_id"
    t.index ["education_id"], name: "index_independent_variables_on_education_id"
    t.index ["guidelines_reference_id"], name: "index_independent_variables_on_guidelines_reference_id"
    t.index ["health_id"], name: "index_independent_variables_on_health_id"
    t.index ["involved_structure_id"], name: "index_independent_variables_on_involved_structure_id"
    t.index ["social_participation_id"], name: "index_independent_variables_on_social_participation_id"
    t.index ["used_technique_id"], name: "index_independent_variables_on_used_technique_id"
    t.index ["work_id"], name: "index_independent_variables_on_work_id"
  end

  create_table "involved_structures", id: :serial, force: :cascade do |t|
  ...
  create_table "legalities", id: :serial, force: :cascade do |t|
  ...
  create_table "main_networks", id: :serial, force: :cascade do |t|
    t.string "i_9_1"
    t.string "i_9_2"
    t.string "i_9_3"
    t.string "i_9_4"
  ...
  create_table "points", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["comunity_id"], name: "index_points_on_comunity_id"
  end

  create_table "ppcls", id: :serial, force: :cascade do |t|
    t.string "name"
    ...
    t.datetime "updated_at", null: false
    t.integer "user_id"
    t.index ["beneficiary_id"], name: "index_ppcls_on_beneficiary_id"
    t.index ["user_id"], name: "index_ppcls_on_user_id"
  end

  create_table "problems_during_processes", id: :serial, force: :cascade do |t|
  ...
  create_table "psychological_situations", id: :serial, force: :cascade do |t|
  ...
  create_table "self_securities", id: :serial, force: :cascade do |t|
  ...
  create_table "sexual_lives", id: :serial, force: :cascade do |t|
    t.string "nao_utiliza_preservativos"
  ...
  create_table "social_participations", id: :serial, force: :cascade do |t|
  ...
  create_table "used_techniques", id: :serial, force: :cascade do |t|
  ...
  add_foreign_key "partners", "people", column: "contact_person_1_id"
  add_foreign_key "partners", "people", column: "contact_person_2_id"
