class FirstContactFile < ApplicationRecord
    ...
    validates_presence_of :place_of_previous_treatments, if: :number_of_previous_treatments_bigger_than_zero?
    def number_of_previous_treatments_bigger_than_zero?
